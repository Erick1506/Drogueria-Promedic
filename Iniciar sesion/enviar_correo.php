...
if ($usuarioEncontrado && $tabla) {
    ...
    try {
        ...
        $mail->SMTPAuth = true;
        $mail->Username = 'promedic853@gmail.com';
        $mail->Password = 'xaaa wkkd yubh zaqm'; // Cambiar por una contraseña de aplicación si usas Gmail
