...
-- Tiempo de generación: 27-11-2024 a las 05:30:56
...
(1, 'Erick', 'Zarto', 'gile01601@gmail.com', 3014370000, 'Admin123');
...
CREATE TABLE `regente` (
  ...
  `Correo` varchar(45) DEFAULT NULL,
  `Telefono` float DEFAULT NULL,
  `Contraseña_Normal` varchar(255) NOT NULL,
...
INSERT INTO `regente` (`Id_Regente`, `Nombre`, `Apellido`, `DNI`, `Fecha_Contratacion`, `Licencia`, `Correo`, `Telefono`, `Contraseña_Normal`, `Contraseña_Encriptada`, `Id_Turno`) VALUES
(1, 'Reegente1', 'sakazar', 131221, '2024-11-24', 1213141516, 'regente@gmail.com', 3012350000, '123456', 0x2432792431302435366635696a39624538356574527164457266726c2e687a56516b377271564561566d644c62646b30593239645845333368562f61, 2);
