...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-12-2024 a las 03:57:43
...
(1, 'Erick', 'Zarto', 'gile01601@gmail.com', 3014370000, 0x243279243130247668632e3265412e6b6e3441705069655a4d7572436563744e5a744f57736b6d756c316e556d732e67695a7133387a2e302e567969);
...
(1, 'Acetaminofe', 'Medicamento para el dolor de cabez', 500, 123456789, '500mg', 2000, 40, 1, 1, 1, 3, 1, '2024-11-21', 20, 70),
...
(9, 'Productos', 'Medicamento para el dolor de cabeza', 500, 979868647, '500mg', 1122, 10, 1, 4, 1, 3, 1, '2025-02-28', 20, 70),
(10, 'Prueba6', 'Elefente', 400, 2147483647, '400g', 1122, 60, 1, 1, 1, 3, 1, '2024-11-08', 20, 80),
(11, 'Prueb2', 'Medicamento para el dolor de cabeza', 8000, 2147483647, '400g', 10000, 30, 1, 1, 1, 3, 1, '2024-11-30', 10, 24),
(12, 'Prueba', 'pepino', 500, 1234321, '500mg', 2000, 40, 1, 1, 1, 3, 1, '2024-11-27', 60, 100),
...
(16, 'Acetaminofen', 'Medicamento para el dolor de cabeza', 1000, 1927345, '500mg', 5000, 50, 1, 1, 3, 3, 1, '2025-01-25', 10, 100),
(17, 'Dolex', 'para la gripa', 1000, 2147483647, '500mg', 6000, 80, 1, 4, 3, 3, 3, '2024-11-30', 20, 120);
...
(1, 1, 15, 1, '2024-11-25', '2024-12-07', 0),
(2, 1, 16, 2, '2024-11-26', '2024-12-07', 0),
...
INSERT INTO `regente` (`Id_Regente`, `Nombre`, `Apellido`, `DNI`, `Fecha_Contratacion`, `Licencia`, `Correo`, `Telefono`, `Contraseña_Encriptada`, `Id_Turno`) VALUES
(1, 'darwin', 'mora', 131221, '2024-11-24', 1213141516, 'darwin@gmail.com', 3012350000, 0x2432792431302435366635696a39624538356574527164457266726c2e687a56516b377271564561566d644c62646b30593239645845333368562f61, 3),
(15, 'Stiven', 'Fraile', 112663353, '2024-12-02', 1234567890, 'stiven123@gmail.com', 3213460000, 0x243279243130245a5665466c76795643416952724b335373553041774f7a51755949415135666e4e4f346973496169446775335078722e37362f4b57, 2);
...
--
ALTER TABLE `regente`
  MODIFY `Id_Regente` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT de la tabla `transacciones`
--
ALTER TABLE `transacciones`
  MODIFY `Id_Transacciones` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
