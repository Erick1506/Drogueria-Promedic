...
<head>
    ...
    <link rel="stylesheet" href="diseñoagrega.css">
</head>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page"
                            href="http://localhost/PROMEDIC/Rol_Admin/Crud/index.php">Inicio</a>
                    </li>
                    <li class="nav-item"></li>
                    <a class="nav-link active" aria-current="page"
                        href="http://localhost/PROMEDIC/Rol_Admin/proveedor_bd/interfaz_proveedor.php">Proveedores</a>
                    </li>
    </nav>
                    ...
                    <fieldset>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" id="nombreProducto" name="nombre_producto" class="form-control"
                                    required>
                            </div>
                            <div class="col-md-6">
                                <label for="descripcionProducto" class="form-label">Descripción</label>
                                <input type="text" id="descripcionProducto" name="descripcion_producto"
                                    class="form-control">
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="number" id="cantidadProducto" name="cantidad_stock"
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="number" id="cantidadMinima" name="cantidad_minima" class="form-control"
                                    required>
                            </div>
                            <div class="col-md-6">
                                <label for="cantidadMaxima" class="form-label">Cantidad Máxima de Stock</label>
                                <input type="number" id="cantidadMaxima" name="cantidad_maxima" class="form-control"
                                    required>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="number" id="costoAdquisicion" name="costo_adquisicion"
                                    class="form-control">
                            </div>
                            <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        <select class="form-select" id="marcaProducto" name="id_marca" required>
                            <?php if ($marcas): ?>
                                <?php foreach ($marcas as $marca): ?>
                                    <option value="<?php echo $marca['Id_Marca']; ?>"><?php echo $marca['Nombre_Marca']; ?>
                                    </option>
                                <?php endforeach; ?>
                            <?php else: ?>
                        ...
                        <button type="button" class="btn btn-outline-secondary" data-bs-toggle="modal"
                            data-bs-target="#modalNuevaMarca">+</button>
                    </div>
                </div>
                <div class="col-md-6">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <button type="button" class="btn btn-outline-secondary" data-bs-toggle="modal"
                            data-bs-target="#modalNuevaCategoria">+</button>
                    </div>
                </div>
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                            ...
                            <?php if ($clasificaciones): ?>
                                <?php foreach ($clasificaciones as $clasificacion): ?>
                                    <option value="<?php echo $clasificacion['Id_Clasificacion']; ?>">
                                        <?php echo $clasificacion['Nombre_Clasificacion']; ?></option>
                                <?php endforeach; ?>
                            <?php else: ?>
                        ...
                        <button type="button" class="btn btn-outline-secondary" data-bs-toggle="modal"
                            data-bs-target="#modalNuevaClasificacion">+</button>
                    </div>
                </div>
            </div>
            <!-- ... -->
    ...
    <div class="modal fade" id="modalNuevaClasificacion" tabindex="-1" aria-labelledby="modalNuevaClasificacionLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <label for="nuevaClasificacionDescripcion" class="form-label">Descripción de la nueva
                        clasificación</label>
