...
<head>
    ...
    <link rel="stylesheet" href="diseñoagreg.css"> 
</head>
<body>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="http://localhost/PROMEDIC/rol_regente/Crud/index.php">Inicio</a>
            </li>
            <li class="nav-item"></li>
                <a class="nav-link active" aria-current="page" href="http://localhost/PROMEDIC/rol_regente/proveedor_bd/interfaz_proveedor.php">Proveedores</a>
            </li>
  </nav>
